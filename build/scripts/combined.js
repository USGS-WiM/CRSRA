...
require([
    ...
    require([
        ...
        zonalStatsGP = new Geoprocessor("https://gis1.wim.usgs.gov/server/rest/services/GLCWRA/CRSRAZonalStats/GPServer/CRSRAZonalStats");
        ...
        $(".zoomto").hover(function (event) {
            ...
            $("#zoomcenter").click(function (e){
                ...
                var dataCenter = new Point(crsra.globals.mapCenter , new SpatialReference({wkid:4326}));
