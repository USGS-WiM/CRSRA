...
require([
    ...
    function showShareModal() {
        ...
        var cleanURL = "http://wlera.wim.usgs.gov/crsra/";
    ...
    function printMap() {
        ...
        if (userTitle === "") {
            template.layoutOptions = {
                ...
                "copyrightText": "This page was produced by the CRSRA web application at wlera.wim.usgs.gov/crsra",
